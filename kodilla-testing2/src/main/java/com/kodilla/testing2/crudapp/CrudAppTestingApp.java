...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://romcioromcio.github.io/");

        WebElement taskInput = driver.findElement(By.xpath(XPATH_INPUT));
        taskInput.sendKeys("New robotic task");

        WebElement taskTextArea = driver.findElement(By.xpath(XPATH_TEXTAREA));
        taskTextArea.sendKeys("The robotic content");
